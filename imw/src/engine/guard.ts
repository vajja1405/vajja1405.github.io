...
export const SCORE_REQUEST = /(\b(rate|score|rank)\b.*\b(him|rahul|candidate)\b|\bout of (10|ten|100)\b|percent(age)? (match|fit)|%\s?(match|fit)|match (score|percentage)|fit score|is (he|rahul) (the )?(best|perfect|ideal|a good|great)|should (we|i) hire|would (he|rahul) be (a )?(good|great|perfect))/i;
